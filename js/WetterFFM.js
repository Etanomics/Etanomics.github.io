(function () {
    ...
    var tableSchema = {
        id: "Wetter",
        alias: "Wetter in Frankfurt Airport Station 10637",
        columns: cols
    };
   ...
   myConnector.getData = function(table, doneCallback) {
    $.getJSON("https://api.meteostat.net/v1/history/hourly?station=10637&start=2020-03-16&end=2099-01-01&time_zone=Europe/Berlin&time_format=Y-m-d%20H:i&key=aaCp5YRV", function(resp) {
        var feat = resp.data,
            tableData = [];
    ...
    $("#submitButton").click(function () {
        tableau.connectionName = "Wetter in Frankfurt";
        tableau.submit();
    });
});
})();