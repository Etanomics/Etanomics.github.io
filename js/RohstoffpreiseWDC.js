   ...
   myConnector.getData = function(table, doneCallback) {
    ...
    $("#submitButton").click(function() {
            ...
            if (isValidDate(infoObj.startDate) && isValidDate(infoObj.endDate)) {
                ...
                tableau.connectionName = "Rohstoffpreise in [" + infoObj.currency + "/ Einheit<" + infoObj.unit + ">] für " + infoObj.code + " vom " + infoObj.startDate + " bis " + infoObj.endDate; // This will be the data source name in Tableau
